...
export interface PlayerProfileScreenProps {
  ...
  /** Whether this is the current user's own profile (hides friend + chat buttons) */
  isOwnProfile?: boolean;
  /** Callback to go back */
  onBack: () => void;
  /** If provided, a Chat button is shown for non-own profiles */
      ...
      <div className="flex-1 overflow-y-auto bg-black pb-4">
        ...
        <div className="mx-4 mt-4 bg-white rounded-xl shadow-xl border border-gray-200 overflow-hidden">
          ...
          <div className="bg-white p-6 pt-14">
            ...
            {!profileLoading &&
              (socialProfile?.xUrl ||
                socialProfile?.telegramUrl ||
                socialProfile?.youtubeUrl ||
                socialProfile?.githubUrl) && (
                <div
